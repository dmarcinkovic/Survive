...
Body::Body(Entity &entity2D, const BodyType &bodyType, float mass, const glm::vec2 &initialVelocity)
...
Circle::Circle(Entity &circle, float radius, float mass, const BodyType &bodyType, const glm::vec2 &initialVelocity)
...
Rectangle::Rectangle(Entity &rectangle, float width, float height, float mass, const BodyType &bodyType,
